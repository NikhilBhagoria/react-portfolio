          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-[var(--color-text-primary)]">
            ...
            <div className="lg:ml-12 animate__animated animate__fadeInRight">
              <div className="bg-[var(--color-card-bg)] p-8 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold text-[var(--color-text-primary)] mb-4">Quick Facts</h3>
                <ul className="space-y-4 text-[var(--color-text-secondary)]">
                  <li className="flex items-center">
                    <svg className="h-5 w-5 text-[var(--color-accent-primary)] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
