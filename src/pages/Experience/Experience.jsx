                ...
                <div className="flex items-center w-full my-6 -ml-1.5">
                  <div className="w-1/2 pr-8 text-right">
                    <div className="p-6 bg-white rounded-lg shadow-lg">
                      <h3 className="text-xl font-bold text-neutral-900">React Developer</h3>
                      <p className="text-blue-600 font-semibold">EXTENSIVE HOST PVT. LTD</p>
                      <p className="text-neutral-600">Sep 2023 - Oct 2024</p>
              ...
              <div className="relative animate__animated animate__fadeInRight">
                <div className="flex items-center w-full my-6 -ml-1.5">
                  ...
                  <div className="w-1/2 pl-8">
                    <div className="p-6 bg-white rounded-lg shadow-lg">
                      <h3 className="text-xl font-bold text-neutral-900">ReactJS Developer Intern</h3>
                      <p className="text-blue-600 font-semibold">NEERJA SOFTWARES PVT. LTD</p>
                      <p className="text-neutral-600">Feb 2023 - July 2023</p>
                      <ul className="mt-4 text-neutral-600 list-disc list-inside space-y-2">
